...
const EditModal = ({open}) => {
    ...
    console.log(opener, "pagload pala")
   ...
   const handleClose = () => {
    ...
    const handleClickEdit = () => {
      ...
      return axios.get(`${API_URL}/items/get-item/${formData._id}`, formData)
      .then((res) => {
        console.log(res, "rowselected")
  })
  .catch((err) => {
        console.log(err)
  })
  ...
  return (
    <div>
                      ...
                      onClick={() => {
                      handleClickEdit()
                      console.log(formData, "sulod han form")
...
<Table m="dense">
  ...
  <TextField
    ...
    name="businessUnit"
    label="Business Unit"
    value={itemData.businessUnit}
    defaultValue={itemData.businessUnit}
    fullWidth
    variant="standard"
  />
  <TextField
